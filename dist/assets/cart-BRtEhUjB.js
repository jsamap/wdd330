import{r as e,l as s,s as c,g as o,a as i}from"./utils-DAaM6Wbz.js";class n{constructor(t,r){this.dataSource=t,this.listElement=r}async init(){this.renderList(this.dataSource)}cartItemTemplate(t){return`<li class="cart-card divider">
