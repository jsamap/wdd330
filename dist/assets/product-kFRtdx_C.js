import { g as a, a as r, s as d, b as c } from "./utils-DlYW4DG9.js";
import { P as n } from "./ProductData-Dx0C3TkS.js";
class s {
  constructor(e, o) {
  ...
  async init() {
    (this.product = await this.dataSource.findProductById(this.productId)),
      ...
      document
        .getElementById("addToCart")
        .addEventListener("click", this.updateCartItemsNumber);
  }
  addProductToCart(e) {
    const o = a("so-cart") || [];
    o.push(this.product), r("so-cart", o);
  }
